document.addEventListener('DOMContentLoaded', () => {
    ...
    // Não é mais necessário atualizar os gráficos aqui, pois o botão fará isso.
    // Apenas garantimos que os dados estão salvos em 'resultadosCalculados'

    secaoResultado.classList.remove('hidden');
    // CORREÇÃO 1: Garantir que a seção de gráficos comece escondida
    ...
    // CORREÇÃO 2: Apenas remover a classe 'hidden' para sempre mostrar
    graficosResultadoContainer.classList.remove('hidden');
    
    // Atualiza os gráficos apenas quando o botão é clicado
